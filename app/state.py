"""Управление состоянием Streamlit-сессии.
Зачем нужен:
- хранить последний extractor/rule-based/LLM результат;
- сбрасывать устаревший LLM-прогноз при новом запуске;
- собирать combined JSON для UI-экспорта.
"""
