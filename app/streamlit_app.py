...
if run:
    ...
    with col_left:
        ...
        st.subheader("Локализация плаценты")
    ...
    with col_right:
        ...
        st.subheader("Клинический контекст")
    ...
    with col_pos:
        st.subheader("Признаки PAS")
        show_findings(positive_findings, "positive")

    with col_unc:
        st.subheader("Неопределённые находки")
        show_findings(uncertain_findings, "uncertain")

    with col_neg:
        st.subheader("Признаки против PAS")
