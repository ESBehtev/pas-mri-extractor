...
from pas_mri_extractor.llm.client import ModelConfigError, dry_run_model_config
from pas_mri_extractor.services.pipeline import extract_features_with_artifacts
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model",
        default=None,
        help="OpenAI-compatible API profile name from configs/models.yaml",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Validate selected OpenAI-compatible API profile without making a request.",
    )
